...
def build_tree(data, features):
    ...
    split = gains.index(max(gains))  # Find max gains and return its index
...
'''Main program'''
dataset, features = load_csv("D:\College\P3_data3.csv")  # Read Tennis data
node = build_tree(dataset, features)  # Build decision tree
print("The decision tree for the dataset using ID3 algorithm is ")
print_tree(node, 0)

testdata, features = load_csv("D:\College\P3_data3_test.csv")
